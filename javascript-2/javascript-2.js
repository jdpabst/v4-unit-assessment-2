...
let saleProducts = products.map(({name, color, price}) => {
...
*/
// They wanted the actual number of the item in the array to be used, but I think the way below is a more accurate way to find the info they are asking for
// let i = userInfo.topics.length-1;
// let topic = userInfo.topics[i]
...
let person = {
  name: 'name',
  age: 29,
  jobs: ['cat mom', 'estate manager', 'chef'],
  birthday: function(){
    this.age += 1;
  },
  favorites: {
