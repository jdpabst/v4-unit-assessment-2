...
for(var i = 0 ; i < lettersToPair.length ; i++){
    for(var j = i + 1 ; j < lettersToPair.length  ; j++){
...
//CODE HERE
  let phone1 = new Phone('a', 'b', 2, 'c', false)
  
  let phone2 = new Phone('d', 'e', 3, 'f', false)
  
  let phone3 = new Phone('g', 'h', 4, 'i', false)
